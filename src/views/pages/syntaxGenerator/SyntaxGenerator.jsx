...
import {
  stateCleanup,
  updateFields,
} from "../../../redux/syntaxgenerator/actions";
import SyntaxBrokerButton from "../../../../src/components/SyntaxBrokerButton";
import RowMapper from "../../../../src/components/RowMapper";
import variety from "../../../../src/constants/Variety";
import exchange from "../../../../src/constants/Exchange";
import funds from "../../../../src/constants/Funds";
import TransactionTypes from "../../../../src/constants/TransactionType";
import orderType from "../../../../src/constants/OrderType";
import product from "../../../../src/constants/Product";
import colors from "../../../../src/constants/Colors";
import stoplossordertype from "../../../../src/constants/StoplossOrderType";
import normal from "../../../../src/constants/Normal";
import orderTypeMarket from "../../../../src/constants/OrderTypeMarket";
import calputselection from "../../../../src/constants/CalPutSelection";
import plusminus from "../../../../src/constants/PlusMinus";
import close from "../../../../src/constants/Close";
import SyntaxBrokerInput from "../../../../src/components/SyntaxBrokerInput";
    ...
    <div style={{ padding: 25 }}>
      ...
      >
        ...
        <div>
              ...
              <Modal show={show}>
                ...
                <Modal.Body>
                  ...
                  >
                    ...
                    "E":"{syntaxGeneratorState.inputValues.exchange}", "IT":"
                    {syntaxGeneratorState.inputValues.IT}", "TS":"
                    {syntaxGeneratorState.inputValues.TS},
                    {syntaxGeneratorState.inputValidity.quantitypercentage ? (
                      <>
                        "Q":"{syntaxGeneratorState.inputValues.quantity}%",
                        "FUND":"{syntaxGeneratorState.inputValues.funds}",
                        "LEVERAGE":"{syntaxGeneratorState.inputValues.LEVERAGE}
                        X", "PER_LOT_SIZE":"
                        {syntaxGeneratorState.inputValues.perLotSize}", "OT":"
            ...
            <>
              <div>
                ...
                <input
                  type="checkbox"
                  name="checkbox"
                  checked={syntaxGeneratorState.inputValidity.triggerPercentage}
                  onChange={() =>
                    dispatch(
                      updateFields(
                        "%",
                    ...
                    "SLM" ? (
                      <>
                        {syntaxGeneratorState.inputValues.triggerPercentage ? (
                          <>
                            "TRP":"+
                            {syntaxGeneratorState.inputValues.triggerPrice}%",
                          </>
                        ) : (
                          <>
                            "TRP":"+
          ...
          syntaxGeneratorState.inputValues.variety === "EXITORDER" ? (
            <>
              ...
              <input
                type="checkbox"
                name="checkbox"
                checked={syntaxGeneratorState.inputValidity.quantitypercentage}
                onChange={() =>
                  dispatch(
                    updateFields(
                      "%",
          ...
          {syntaxGeneratorState.inputValidity.variety &&
          syntaxGeneratorState.inputValues.variety === "ALTERNATIVESYMBOLS" ? (
            <>
              <SyntaxBrokerInput
                header="Trading Symbol"
                value={syntaxGeneratorState.inputValues.TS}
              ...
              <Modal show={show}>
                ...
                <Modal.Body>
                  ...
                  >
                    [&#123; "AS":"{syntaxGeneratorState.inputValues.TS}", "E":"
                    {syntaxGeneratorState.inputValues.exchange}",
                    {syntaxGeneratorState.inputValidity.quantitypercentage ? (
                      <>
                        "Q":"{syntaxGeneratorState.inputValues.quantity}
                  ...
                  >
                    ...
                    {syntaxGeneratorState.inputValidity.quantitypercentage ? (
                      <>
                        "Q":"{syntaxGeneratorState.inputValues.quantity}
                        %", "FUND":"
                        {syntaxGeneratorState.inputValues.funds}", "LEVERAGE":"
          ...
          syntaxGeneratorState.inputValues.variety === "AUTOSTRIKEPRICE" ? (
            <>
              ...
              <Modal show={show}>
                ...
                <Modal.Body>
                  {syntaxGeneratorState.inputValues.close === "WITHOUTCLOSE" ? (
                    <>
                      <p
                        style={{
                          fontSize: 16,
